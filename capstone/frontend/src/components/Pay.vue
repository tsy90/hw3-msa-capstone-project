<template>
    ...
    <v-card style="width:300px;" outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Boolean label="SucessYn" v-model="value.sucessYn" :editMode="editMode"/>
            </div>
            <div>
            ...
            <div>
                <String label="PayId" v-model="value.payId" :editMode="editMode"/>
            </div>
            <div>
    ...
    export default {
        ...
        created(){
            ...
            if(typeof this.value === 'object') {
                ...
                if(!('sucessYn' in this.value)) {
                    this.value.sucessYn = null;
                }
